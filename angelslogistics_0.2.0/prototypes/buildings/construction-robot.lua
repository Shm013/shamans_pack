  data:extend(
  {
    ...
    idle =
    {
      filename = "__angelslogistics__/graphics/entity/construction-robot/construction-robot.png",
      priority = "high",
      line_length = 16,
      width = 128,
      height = 128,
    ...
    shadow_idle =
    {
      filename = "__angelslogistics__/graphics/entity/construction-robot/construction-robot-shadow.png",
      priority = "high",
      line_length = 16,
      width = 64,
      height = 64,
    ...
    working =
    {
      filename = "__angelslogistics__/graphics/entity/construction-robot/construction-robot-working.png",
      priority = "high",
      line_length = 2,
      width = 128,
      height = 128,
