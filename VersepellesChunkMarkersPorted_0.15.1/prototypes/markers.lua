...
local marker_names = {
	...
	["pink-rectangle-marker"] = {order = "g", subgroup = "rectangle-markers"},
	["yellowgreen-rectangle-marker"] = {order = "h", subgroup = "rectangle-markers"},
	["cyan-rectangle-marker"] = {order = "i", subgroup = "rectangle-markers"},
	["brown-rectangle-marker"] = {order = "j", subgroup = "rectangle-markers"},
	["white-rectangle-marker"] = {order = "k", subgroup = "rectangle-markers"},
	...
	["pink-chunk-marker"] = {order = "g", subgroup = "chunk-markers"},
	["yellowgreen-chunk-marker"] = {order = "h", subgroup = "chunk-markers"},
	["cyan-chunk-marker"] = {order = "i", subgroup = "chunk-markers"},
	["brown-chunk-marker"] = {order = "j", subgroup = "chunk-markers"},
	["white-chunk-marker"] = {order = "k", subgroup = "chunk-markers"},
