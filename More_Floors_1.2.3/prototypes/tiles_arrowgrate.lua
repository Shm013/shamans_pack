...
{
     {
      ...
      variants =
      {
        main =
        {
		  ...
		  {
            picture = "__More_Floors__/graphics/terrain/metal-floor/large-arrow-grate-up1.png",
            count = 1,
            size = 2,
            probability = 1.00,
          },
    ...
    },
    {
      ...
      variants =
      {
        main =
        {
		  ...
		  {
            picture = "__More_Floors__/graphics/terrain/metal-floor/large-arrow-grate-right1.png",
            count = 1,
            size = 2,
            probability = 1.00,
          },
    ...
    },
	{
      ...
      variants =
      {
        main =
        {
		  ...
		  {
            picture = "__More_Floors__/graphics/terrain/metal-floor/large-arrow-grate-down1.png",
            count = 1,
            size = 2,
            probability = 1.00,
          },
    ...
    },
    {
      ...
      variants =
      {
        main =
        {
		  ...
		  {
            picture = "__More_Floors__/graphics/terrain/metal-floor/large-arrow-grate-left1.png",
            count = 1,
            size = 2,
            probability = 1.00,
          },
