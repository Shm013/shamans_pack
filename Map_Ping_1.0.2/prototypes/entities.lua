...
data:extend({
	{
		type = "container",
		name = "ping-tool",
		icon = "__Map_Ping__/graphics/PingTool.png",
		icon_size = 32,
		...
		picture =
		{
			filename = "__Map_Ping__/graphics/PingTool.png",
			width = 32,
			height = 32,
			shift = {0, 0}
		}
			...
			{
				{
					...
					{
						{
							filename = "__Map_Ping__/graphics/Pingsplosion1.png",
							width_in_frames = 8,
							height_in_frames = 8,
						},
						{
							filename = "__Map_Ping__/graphics/Pingsplosion2.png",
							width_in_frames = 8,
							height_in_frames = 8,
						}
					}
