for i, ore in pairs(bobmods.ores) do
  if ore.enabled then
    ...
    data.raw["map-gen-presets"].default["rich-resources"].basic_settings.autoplace_controls[ore.autoplace.control] = {richness = "very-good"}
    data.raw["map-gen-presets"].default["rail-world"].basic_settings.autoplace_controls[ore.autoplace.control] = {frequency = "very-low", size = "high"}
