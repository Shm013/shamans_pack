...
--WASHING
    ...
    results=
    {
		{type="fluid", name="water-heavy-mud", amount=150},
    ...
    results=
    {
		{type="fluid", name="water-concentrated-mud", amount=150},
		{type="item", name ="solid-mud", amount_min = 0, amount_max = 3, probability = 0.5},
    },
    ...
    results=
    {
		{type="fluid", name="water-light-mud", amount=150},
		{type="item", name ="solid-mud", amount_min = 0, amount_max = 3, probability = 0.5},
    },
    ...
    results=
    {
		{type="fluid", name="water-thin-mud", amount=150},
		{type="item", name ="solid-mud", amount_min = 0, amount_max = 3, probability = 0.5},
    },
    ...
    results=
    {
		{type="fluid", name="water-saline", amount=150},
		{type="item", name ="solid-mud", amount_min = 0, amount_max = 3, probability = 0.5},
    },
