...
local function addTechnology()
  KaoExtended.NewTechnology("to-slag-1", {"ore-crushing"}, "a-a")
  ...
  KaoExtended.NewTechnology("to-slag-2", {"to-slag-1"}, "a-a")
  ...
  KaoExtended.NewTechnology("to-slag-3", {"to-slag-2"}, "a-a")
  ...
  KaoExtended.NewTechnology("to-slag-4", {"to-slag-3"}, "a-a")
