...
script.on_event(defines.events.on_gui_click, function(event)
  local player = game.players[event.player_index]
  local entity = global.bobmods.inserters[event.player_index].entity
  if event.element.valid and entity and entity.valid and player.can_reach_entity(entity) then
...
--  mod_gui.get_button_flow(player).add{type = "checkbox", name = "bob_logistics_inserter_button", state = global.bobmods.logistics[player_index].show, style = "bob-logistics-inserter-button"}
...
function bobmods.inserters.open_gui(entity, player)
  ...
  gui.add({type = "button", name = "bob_inserter_gui_close", caption = {"gui.ok"}})
