...
ent.picture_off =
    {
      filename = "__shmlamps__/graphics/entity/" .. name .. "/light-off.png",
      priority = "high",
      width = 134,
      height = 116,
      frame_count = 1,
...
ent.picture_on =
    {
      filename = "__shmlamps__/graphics/entity/" .. name .. "/light-on-patch.png",
      priority = "high",
      width = 134,
      height = 116,
      frame_count = 1,
...
ent.picture_off.filename = "__shmlamps__/graphics/entity/" .. name .. "/light-off.png"
data:extend({ent})
