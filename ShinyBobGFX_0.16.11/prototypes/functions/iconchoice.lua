...
if powerbar == 1 then
	if entity then entity.icons = {{icon = ipath..complete..".png"},{icon = ipath.."num-"..mk-off..".png"}} 
	entity.icon = nil
	end
	if item then item.icons = {{icon = ipath..complete..".png"},{icon = ipath.."num-"..mk-off..".png"}} 
	item.icon = nil
	end
