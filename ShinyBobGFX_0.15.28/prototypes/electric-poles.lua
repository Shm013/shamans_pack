if data.raw["electric-pole"]["medium-electric-pole"] then
    ...
    entity.pictures["filename"] = "__ShinyBobGFX__/graphics/entity/poles/medium-electric-pole.png"
end
...
bobicon("substation","electric-pole",1,4,0)
    ...
    data.raw["electric-pole"]["medium-electric-pole-2"].pictures["filename"] = "__ShinyBobGFX__/graphics/entity/poles/medium-electric-pole-2.png"
end
...
if data.raw["electric-pole"]["medium-electric-pole-3"] then
    ...
    data.raw["electric-pole"]["medium-electric-pole-3"].pictures["filename"] = "__ShinyBobGFX__/graphics/entity/poles/medium-electric-pole-3.png"
end
...
if data.raw["electric-pole"]["medium-electric-pole-4"] then
    ...
    data.raw["electric-pole"]["medium-electric-pole-4"].pictures["filename"] = "__ShinyBobGFX__/graphics/entity/poles/medium-electric-pole-4.png"
end
