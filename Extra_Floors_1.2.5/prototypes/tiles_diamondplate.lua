data:extend(
{
  {	
      ...
      variants =
      {
        ...
        {
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/diamond-plate1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/diamond-plate2.png",
            count = 4,
            size = 2,
            probability = 0.39,
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/diamond-plate4.png",
            count = 4,
            size = 4,
            probability = 1,
          },
