data:extend(
{
  {	  
      ...
      variants =
      {
        ...
        {
          {
             picture = "__Extra_Floors__/graphics/terrain/metal-floor/circuit-floor1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/circuit-floor2.png",
            count = 4,
            size = 2,
            probability = 0.08,
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/circuit-floor4.png",
            count = 4,
            size = 4,
            probability = .10,	
          },  
