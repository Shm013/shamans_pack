data:extend(
{
  {	
      ...
      variants =
      {
        ...
        {
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/rusty-grate1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/rusty-grate2.png",
            count = 4,
            size = 2,
            probability = 0.39,
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/metal-floor/rusty-grate4.png",
            count = 4,
            size = 4,
            probability = 1,
          },
