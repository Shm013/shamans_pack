data:extend(
{
  {	
      ...
      variants =
      {
        ...
        {
          {
            picture = "__Extra_Floors__/graphics/terrain/stone-floor/smooth-concrete1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/stone-floor/smooth-concrete2.png",
            count = 4,
            size = 2,
            probability = 0.39,
          },
          {
            picture = "__Extra_Floors__/graphics/terrain/stone-floor/smooth-concrete4.png",
            count = 4,
            size = 4,
            probability = 1,
          },
