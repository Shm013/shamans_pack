...
rail_pictures_c = function()
  return rail_pictures_internal_c({{"metals", "metals", mipmap = true},
  ...
  for _ , key in ipairs(keys) do
    ...
    for _ , elem in ipairs(elems) do
      part[elem[1]] = { sheet = {
        ...
        hr_version = {
          filename = string.format("__Bio_Industries__/graphics/entities/wood_products/%s-concrete/hr-%s-%s-%s.png", dashkey, dashkey, key[2], elem[2]),
          priority = "extra-high",
          flags = elem.mipmap and { "icon" },
          width = key[3]*2,
          height = key[4]*2,
   ...
   {
     {
       filename = "__Bio_Industries__/graphics/entities/wood_products/rail-endings/rail-endings-background-concrete.png",
       priority = "high",
       width = 128,
       height = 128,
       hr_version = {
         filename = "__Bio_Industries__/graphics/entities/wood_products/rail-endings/hr-rail-endings-background-concrete.png",
         priority = "high",
         width = 256,
         height = 256,
         scale = 0.5
