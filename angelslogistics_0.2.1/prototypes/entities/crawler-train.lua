    ...
    pictures =
        {
          ...
          filenames =
          {
            "__angelslogistics__/graphics/entity/crawler-train/crawler-loco-1.png",
            "__angelslogistics__/graphics/entity/crawler-train/crawler-loco-2.png",
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.0, -0.75}
    ...
    pictures =
        {
          ...
          filenames =
          {
            "__angelslogistics__/graphics/entity/crawler-train/crawler-loco-wagon-1.png",
            "__angelslogistics__/graphics/entity/crawler-train/crawler-loco-wagon-2.png",
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0.0, -0.75}
    ...
    pictures =
        {
          ...
          filenames =
          {
            "__angelslogistics__/graphics/entity/crawler-train/crawler-wagon.png",
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0, -0.75}
    ...
    pictures =
        {
          ...
          filenames =
          {
            "__angelslogistics__/graphics/entity/crawler-train/crawler-bot-wagon.png",
          },
          line_length = 8,
          lines_per_file = 8,
          shift = {0, -0.75}
