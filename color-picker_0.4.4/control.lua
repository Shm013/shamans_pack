...
local function add_instance(data)
	...
	create_rgba_bar_contents(bar_container, gui_names.red_bar_contents_prefix, {"red"})
	...
	create_rgba_bar_contents(bar_container, gui_names.green_bar_contents_prefix, {"green"})
	...
	create_rgba_bar_contents(bar_container, gui_names.blue_bar_contents_prefix, {"blue"})
	...
	local presets_table = presets_container.add
	{
		...
		colspan = color_picker_defines.presets_per_row
	}
	-- Presets.
