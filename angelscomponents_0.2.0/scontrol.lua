...
iteminsert{name="angels-main-lab", count=10}
iteminsert{name="angels-basic-lab", count=10}

iteminsert{name="angels-alien-lab-1", count=10}
iteminsert{name="angels-alien-lab-2", count=10}
iteminsert{name="angels-alien-lab-3", count=10}
iteminsert{name="angels-alien-lab-4", count=10}
iteminsert{name="angels-alien-lab-5", count=10}

iteminsert{name="angels-energy-lab-1", count=10}
iteminsert{name="angels-energy-lab-2", count=10}
iteminsert{name="angels-energy-lab-3", count=10}
iteminsert{name="angels-energy-lab-4", count=10}
iteminsert{name="angels-energy-lab-5", count=10}

iteminsert{name="datacore-basic", count=100}
iteminsert{name="datacore-alien-1", count=100}
iteminsert{name="datacore-alien-2", count=100}
iteminsert{name="datacore-automation-1", count=100}
iteminsert{name="datacore-automation-2", count=100}
...
iteminsert{name="datacore-modules-1", count=100}
iteminsert{name="datacore-modules-2", count=100}
...
iteminsert{name="angels-science-pack-purple", count=100}
end)
