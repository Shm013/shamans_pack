...
--LOGISTIC LAB
  {
    ...
    icon = "__angelscomponents__/graphics/icons/logistic-lab-ico.png",
  ...
  },
  {
    ...
    on_animation =
    {
      filename = "__angelscomponents__/graphics/entity/logistic-lab/logistic-lab.png",
      width = 160,
      height = 160,
      frame_count = 36,
      line_length = 6,
    ...
    off_animation =
    {
      filename = "__angelscomponents__/graphics/entity/logistic-lab/logistic-lab-off.png",
      width = 160,
      height = 160,
      frame_count = 1,
      shift = {0, 0}
