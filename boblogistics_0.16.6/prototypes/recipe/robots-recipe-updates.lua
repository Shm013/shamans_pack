...
bobmods.lib.recipe.add_ingredient("bob-logistic-robot-5", {"fusion-reactor-equipment", 1})
bobmods.lib.recipe.add_ingredient("bob-construction-robot-5", {"fusion-reactor-equipment", 1})
