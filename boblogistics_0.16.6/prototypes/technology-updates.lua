if data.raw.tool["logistic-science-pack"] then
  bobmods.lib.tech.replace_science_pack("bob-logistics-4", "production-science-pack", "logistic-science-pack")
  ...
  if data.raw.technology["bob-robotics-3"] then
    bobmods.lib.tech.replace_science_pack("bob-robotics-3", "production-science-pack", "logistic-science-pack")
  end
  ...
  bobmods.lib.tech.replace_science_pack("bob-robots-2", "production-science-pack", "logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("bob-robots-3", "production-science-pack", "logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("bob-robots-4", "production-science-pack", "logistic-science-pack")
  ...
  bobmods.lib.tech.replace_science_pack("logistic-system-3", "production-science-pack", "logistic-science-pack")

  bobmods.lib.tech.replace_science_pack("inserter-stack-size-bonus-3", "production-science-pack", "logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("inserter-stack-size-bonus-4", "production-science-pack", "logistic-science-pack")
  bobmods.lib.tech.replace_science_pack("inserter-capacity-bonus-8", "production-science-pack", "logistic-science-pack")
  ...
  bobmods.lib.tech.replace_science_pack("worker-robots-storage-4", "production-science-pack", "logistic-science-pack")
...
-- Move long inserter onto long inserters research
